        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if (roygbivValue == "HELP")
                {
                    ...
                    roygbivValue = Convert.ToString(Console.ReadLine().ToUpper());
                }
                ...
                Console.WriteLine("Would you like to try again? Type \"YES\" or \"NO\" and hit \"Enter\"");
                yesOrNo = Console.ReadLine().ToUpper();

            }
            while (yesOrNo == "YES");

            Console.WriteLine("May your fortune be your guide!");
            Console.ReadLine();
